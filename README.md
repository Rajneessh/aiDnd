...
1.  **Phase 1: PDF Data Modeling**
    * Transformed unstructured D&D Beyond character sheets and a 30-page campaign module (*The Haunting of House Hargrave*) into a structured Pythonic schema.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/your-username/aiDnd-Hargrave.git](https://github.com/your-username/aiDnd-Hargrave.git)
   cd aiDnd-Hargrave